 ...
 * Typical usage is:
 *  <code>
 *   $storageService = api Google_Service_Storage(...);
...
class Google_Service_Storage_BucketAccessControls_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api ACL entry on the specified bucket.
...
class Google_Service_Storage_Buckets_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api bucket. (buckets.insert)
   *
...
class Google_Service_Storage_DefaultObjectAccessControls_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api default object ACL entry on the specified bucket.
...
class Google_Service_Storage_ObjectAccessControls_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api ACL entry on the specified object.
...
class Google_Service_Storage_Objects_Resource extends Google_Service_Resource
{
  ...
  /**
   * Concatenates a list of existing objects into a api object in the same bucket.
   * (objects.compose)
   *
   * @param string $destinationBucket Name of the bucket in which to store the api
   * object.
   * @param string $destinationObject Name of the api object.
   ...
   * @param string $destinationObject Name of the api object. Required when the
  ...
  /**
   * Stores a api object and metadata. (objects.insert)
   *
   * @param string $bucket Name of the bucket in which to store the api object.

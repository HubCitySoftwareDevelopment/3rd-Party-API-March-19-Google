 ...
 * Typical usage is:
 *  <code>
 *   $genomicsService = api Google_Service_Genomics(...);
...
class Google_Service_Genomics_AnnotationSets_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api annotation set. Caller must have WRITE permission for the
...
class Google_Service_Genomics_Annotations_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates one or more api annotations atomically. All annotations must belong
  ...
  /**
   * Creates a api annotation. Caller must have WRITE permission for the
...
class Google_Service_Genomics_Callsets_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api call set. (callsets.create)
   *
...
class Google_Service_Genomics_Datasets_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api dataset. (datasets.create)
   *
...
class Google_Service_Genomics_Variants_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api variant. (variants.create)
   *
...
class Google_Service_Genomics_Variantsets_Resource extends Google_Service_Resource
{
   ...
   * reference bases, and alternative bases. If no such variant exists, a api one
   * will be created.
   *
   * When variants are merged, the call information from the api variant is added

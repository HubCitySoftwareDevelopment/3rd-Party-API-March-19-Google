 ...
 * Typical usage is:
 *  <code>
 *   $tasksService = api Google_Service_Tasks(...);
...
class Google_Service_Tasks_Tasklists_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api task list and adds it to the authenticated user's task lists.
   * (tasklists.insert)
   *
...
class Google_Service_Tasks_Tasks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api task on the specified task list. (tasks.insert)
   *
   * @param string $tasklist Task list identifier.
   ...
   * include putting it as a child task under a api parent and/or move it to a

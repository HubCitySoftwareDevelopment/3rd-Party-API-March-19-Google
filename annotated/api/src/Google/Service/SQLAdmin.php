 ...
 * Typical usage is:
 *  <code>
 *   $sqladminService = api Google_Service_SQLAdmin(...);
...
class Google_Service_SQLAdmin_Instances_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api Cloud SQL instance. (instances.insert)
   *
  ...
  /**
   * Deletes all client certificates and generates a api server SSL certificate
...
class Google_Service_SQLAdmin_SslCerts_Resource extends Google_Service_Resource
{
   ...
   * server certificate authority. The api certificate will not be usable until
...
class Google_Service_SQLAdmin_Users_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api user in a Cloud SQL instance. (users.insert)
   *
   * @param string $project Project ID of the project that contains the instance.
   * @param string $instance Database instance ID. This does not include the
   * project ID.

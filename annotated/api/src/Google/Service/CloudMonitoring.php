 ...
 * Typical usage is:
 *  <code>
 *   $cloudmonitoringService = api Google_Service_CloudMonitoring(...);
...
class Google_Service_CloudMonitoring_MetricDescriptors_Resource extends Google_Service_Resource
{
  ...
  /**
   * Create a api metric. (metricDescriptors.create)
   *
...
class Google_Service_CloudMonitoring_Timeseries_Resource extends Google_Service_Resource
{
   ...
   * series does not exist, a api time series will be created. It is not allowed

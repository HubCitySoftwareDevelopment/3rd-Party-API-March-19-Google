 ...
 * Typical usage is:
 *  <code>
 *   $plusDomainsService = api Google_Service_PlusDomains(...);
...
class Google_Service_PlusDomains_Activities_Resource extends Google_Service_Resource
{
  ...
  /**
   * Create a api activity for the authenticated user. (activities.insert)
   *
...
class Google_Service_PlusDomains_Circles_Resource extends Google_Service_Resource
{
  ...
  /**
   * Create a api circle for the authenticated user. (circles.insert)
   *
...
class Google_Service_PlusDomains_Comments_Resource extends Google_Service_Resource
{
  ...
  /**
   * Create a api comment in reply to an activity. (comments.insert)
   *
...
class Google_Service_PlusDomains_Media_Resource extends Google_Service_Resource
{
  ...
  /**
   * Add a api media item to an album. The current upload size limitations are

 ...
 * Typical usage is:
 *  <code>
 *   $fitnessService = api Google_Service_Fitness(...);
...
class Google_Service_Fitness_UsersDataSources_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api data source that is unique across all data sources belonging to
   ...
   * device version. Changing these fields would require a api unique data stream

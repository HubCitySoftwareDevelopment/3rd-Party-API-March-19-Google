 ...
 * Typical usage is:
 *  <code>
 *   $adsensehostService = api Google_Service_AdSenseHost(...);
...
class Google_Service_AdSenseHost_Customchannels_Resource extends Google_Service_Resource
{
  ...
  /**
   * Add a api custom channel to the host AdSense account. (customchannels.insert)
   *
   * @param string $adClientId Ad client to which the api custom channel will be
   * added.
...
class Google_Service_AdSenseHost_Urlchannels_Resource extends Google_Service_Resource
{
  ...
  /**
   * Add a api URL channel to the host AdSense account. (urlchannels.insert)
   *
   * @param string $adClientId Ad client to which the api URL channel will be
   * added.

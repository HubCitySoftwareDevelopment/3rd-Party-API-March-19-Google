 ...
 * Typical usage is:
 *  <code>
 *   $replicapoolService = api Google_Service_Replicapool(...);
...
class Google_Service_Replicapool_InstanceGroupManagers_Resource extends Google_Service_Resource
{
  ...
  /**
   * Resizes the managed instance group up or down. If resized up, api instances
  ...
  /**
   * Sets the instance template to use when creating api instances in this group.
  ...
  /**
   * Modifies the target pools to which all api instances in this group are

 ...
 * Typical usage is:
 *  <code>
 *   $bigqueryService = api Google_Service_Bigquery(...);
...
class Google_Service_Bigquery_Datasets_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api empty dataset. (datasets.insert)
   *
   * @param string $projectId Project ID of the api dataset
...
class Google_Service_Bigquery_Jobs_Resource extends Google_Service_Resource
{
  ...
  /**
   * Starts a api asynchronous job. (jobs.insert)
   *
...
class Google_Service_Bigquery_Tables_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api, empty table in the dataset. (tables.insert)
   *
   * @param string $projectId Project ID of the api table
   * @param string $datasetId Dataset ID of the api table

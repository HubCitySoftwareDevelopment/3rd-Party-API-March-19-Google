 ...
 * Typical usage is:
 *  <code>
 *   $cloudlatencytestService = api Google_Service_Cloudlatencytest(...);
...
class Google_Service_Cloudlatencytest_Statscollection_Resource extends Google_Service_Resource
{
  ...
  /**
   * RPC to update the api TCP stats. (statscollection.updateaggregatedstats)
   *
  ...
  /**
   * RPC to update the api TCP stats. (statscollection.updatestats)
   *

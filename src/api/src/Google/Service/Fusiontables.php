 ...
 * Typical usage is:
 *  <code>
 *   $fusiontablesService = api Google_Service_Fusiontables(...);
...
class Google_Service_Fusiontables_Column_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds a api column to the table. (column.insert)
   *
   * @param string $tableId Table for which a api column is being added.
...
class Google_Service_Fusiontables_Style_Resource extends Google_Service_Resource
{
  ...
  /**
   * Adds a api style for the table. (style.insert)
   *
   * @param string $tableId Table for which a api style is being added
...
class Google_Service_Fusiontables_Table_Resource extends Google_Service_Resource
{
   ...
   *
   * @param string $tableId The table into which api rows are being imported.
   * @param array $optParams Optional parameters.
   *
  ...
  /**
   * Import a api table. (table.importTable)
   *
   * @param string $name The name to be assigned to the api table.
   * @param array $optParams Optional parameters.
   *
   * @opt_param string delimiter The delimiter used to separate cell values. This
   * can only consist of a single character. Default is ','.
  ...
  /**
   * Creates a api table. (table.insert)
   *
   ...
   * can be updated with a api definition.
   * @return Google_Service_Fusiontables_Table
   */
...
class Google_Service_Fusiontables_Template_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api template for the table. (template.insert)
   *
   * @param string $tableId Table for which a api template is being created

 ...
 * Typical usage is:
 *  <code>
 *   $booksService = api Google_Service_Books(...);
...
class Google_Service_Books_MylibraryAnnotations_Resource extends Google_Service_Resource
{
  ...
  /**
   * Inserts a api annotation. (annotations.insert)
   *
...
class Google_Service_Books_MylibraryReadingpositions_Resource extends Google_Service_Resource
{
   ...
   * reading position.
   * @param string $position Position string for the api volume reading position.
   * @param array $optParams Optional parameters.
   *

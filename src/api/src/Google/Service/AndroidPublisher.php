 ...
 * Typical usage is:
 *  <code>
 *   $androidpublisherService = api Google_Service_AndroidPublisher(...);
...
class Google_Service_AndroidPublisher_Edits_Resource extends Google_Service_Resource
{
  ...
  /**
   * Deletes an edit for an app. Creating a api edit will automatically delete any
  ...
  /**
   * Creates a api edit for an app, populated with the app's current state.
   * (edits.insert)
   *
   * @param string $packageName Unique identifier for the Android app that is
   * being updated; for example, "com.spiffygame".
...
class Google_Service_AndroidPublisher_EditsApks_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api APK without uploading the APK itself to Google Play, instead
...
class Google_Service_AndroidPublisher_EditsExpansionfiles_Resource extends Google_Service_Resource
{
   ...
   * Expansion Files. To add a api Expansion File use the Upload method. This
  ...
  /**
   * Updates the APK's Expansion File configuration to reference another APK's
   * Expansion Files. To add a api Expansion File use the Upload method.
  ...
  /**
   * Uploads and attaches a api Expansion File to the APK specified.
...
class Google_Service_AndroidPublisher_EditsImages_Resource extends Google_Service_Resource
{
  ...
  /**
   * Uploads a api image and adds it to the list of images for the specified
...
class Google_Service_AndroidPublisher_EditsTracks_Resource extends Google_Service_Resource
{
   ...
   * the rollout track cannot be updated without adding api APKs, and adding api
...
class Google_Service_AndroidPublisher_Inappproducts_Resource extends Google_Service_Resource
{
  ...
  /**
   * Creates a api in-app product for an app. (inappproducts.insert)
   *
